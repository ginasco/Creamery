...
$status="unprocessed";	
	...
	$status="processed";
		...
		//if no data output 
												...
												else{$resultSet=$mysqli->query("SELECT po.datePurchase, po.poNumber, p.productName, po2.purchaseQty, po.ordered, p.wholesalePrice, (wholesalePrice* purchaseQty) 
AS total FROM purchase po JOIN purchase2 po2 ON po2.poNumber=po.poNumber JOIN products p  ON p.productId=po2.productId
WHERE username='$search3' and datePurchase BETWEEN '$search2' AND '$search' ORDER BY po.datePurchase,po.poNumber;");

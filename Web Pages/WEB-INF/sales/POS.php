 ...
 <!-- header -->
  <header id="header" class="app-header navbar" role="menu">
      ...
      <div class="navbar-header bg-dark">
        ...
        <!-- brand -->
        <a href="dashboard.html" class="navbar-brand text-lt">
                ...
                <div class="list-group">
                  <a href class="list-group-item">
                    ...
                    <span class="clear block m-b-none">
                      Product 500ml Chocolate Milk is near expiry.<br>
                      <small class="text-muted">10 minutes ago</small>
                    </span>
                  </a>
                  <a href class="list-group-item">
                    <span class="clear block m-b-none">
                      Product 200g Quesong Puti is low in stock.<br>
                ...
                <ul class="nav nav-sub dk">
                  ...
                  <li>
                    ...
                    <a href="expired.html">
                     ...
                     <li>
<a href="purchaseorder.html">                       <span>Create Purchase Order</span>                     </a>                          <a href="polist.html">                       <span>My Purchase Orders</span>                     </a>
              ...
              <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">          
                ...
                <ul class="nav nav-sub dk">
                  <li class="nav-sub-header">
                    ...
                    <li>
                    <a href="createprod.html">  <span>Create Production Order</span>
                      
                    </a>
                  </li>
                  <li>
                    <a href="admin_pblist.html">
                      <span>List Production Orders</span>
                    </a>
                  </li>
                  <li>
                    <a href="pbreportlist.html">
...
<div class="bg-light lter b-b wrapper-md hidden-print">
  ...
  <h1 class="m-n font-thin h3">Point of Sale</h1>
</div>

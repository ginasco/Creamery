...
if(isset($_POST['submit'])){
    ...
    if(empty($search3)){
    $resultSet=$mysqli->query("SELECT *,(wholesalePrice * qtySR) AS total FROM products p JOIN salessr sr ON sr.productId=p.productId
...
<td width=\"5%\"><div align=\"center\">".$rows['total']."
	...
	else{$resultSet=$mysqli->query("SELECT *,(wholesalePrice * qtySR) AS total FROM products p JOIN salessr sr ON sr.productId=p.productId
